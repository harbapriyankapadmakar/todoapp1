...
var newTask1 = document.querySelector('#new-task1');
...
var createNewTask1 = function(task1){
    console.log("Creating task...");
...
var addTask1 = function(){
    console.log("Adding task...");
    //FOR CLARITY, GRAB THE INPUTTED TEXT AND STORE IT IN A VAR
    var listItem = createNewTask1(newTask1.value);
    //ADD THE NEW LIST ITEM TO LIST
    toDoUl.appendChild(listItem); 
    //CLEAR THE INPUT
    newTask1.value="";
    ...
    //BIND THE NEW LIST ITEM TO THE INCOMPLETE LIST
    bindIncompleteItems(listItem, completeTask1);
